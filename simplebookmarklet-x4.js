...
void(function($){'use strict';
 const o=$,p='uid-xyz';(o[p]||(o[p]=function($){
	...
	inibite=function(evt){const e=evt;e.preventDefault();e.stopPropagation();return false;},
	...
	process=Freeze(function(evt){
	 ...
	 if(e!==null){
		...
		e.normalize();
		const dE=e,w2=((e=o.opened)===null||e.closed)?on((o.opened=w1.open('about:blank')),'beforeunload',function(){o.opened=null;}).target:e,
		stopclick=on(w2,'click',inibite).listener,
		d2=w2.document;
