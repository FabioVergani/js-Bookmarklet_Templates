javascript:void(function($){'use strict';
 ...
 (o[p]||(o[p]=(function($){
	...
	XMLSerializer=new w.XMLSerializer(),
	sealed=Seal(aRawObjDescribed({
	 ...
	 go:{
		value:function($){
		 var o=sealed;
		 if(o.locked===false){
			var w=$, d=w.document, f=function(evt){
			 var w2=w.open('data:text/html,'+XMLSerializer.serializeToString(d.doctype)), d2=w2.document;
