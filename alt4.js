javascript:'use strict';void((function(thewindow){
 ...
 ((typeof(e)==='object' && 'use' in e)?e:(o=Object,o=w.fv=o.preventExtensions(

o.create(null,(o={value:0,writable:true},{
	use:{
	...
	events:{
	 get:function(){return Object.keys(this.action);}
	},
	calls:o,
	run:o
 }))
