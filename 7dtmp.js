...
on(,'contextmenu',inibit)
w2.alert(2);
w1.alert(1);
w1.open('www.google.it');

const e=evt,w2=e.currentTarget;
if(w2.confirm('ss')){w2.open('data:text/plain;charset=utf-8,');};

const e=evt,w2=e.currentTarget;
if(w2.confirm('show-source?')){
w2.open('');
};



w2.open('data:text/plain;charset=utf-8,');
